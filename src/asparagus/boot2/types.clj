(ns asparagus.boot2.types
  (:refer-clojure :exclude [parents >= <=])
  (:require [asparagus.boot2.prelude :as p
             :refer [cs $ $vals]]
...
(do :extension
    ...
    (defmacro tag+
      ...
      "add a type tag to the type registry (living in asparagus.boot2.state/state)
    ...
    (comment
      ...
      (asparagus.boot2.generics/g1 (Pouet. 1 2)))
